...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
  Hello! I&apos;m Zain ul Abdeen, a dedicated web developer and tech enthusiast.
   I specialize in building responsive and user-friendly web applications and 
   currently pursue a passion for creating innovative solutions at TechStore. 
   I&apos;m well-versed in technologies like HTML, CSS, JavaScript, and ASP.NET Core,
    with hands-on experience in MySQL and SQL Server Express. I excel at frameworks and 
    tools such as Bootstrap and PHP, ensuring seamless backend and frontend integration. 
    My skills extend to database management and interactive UI design, making me proficient
     in delivering end-to-end web solutions.
  ...
  Let&apos;s work together to turn your ideas into reality!
        ...
        <Link
          href="/document/MZainulabdeencv.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
